...
const HARDCODED_CONTACTS: Contact[] = [
  ...
  { name: 'Louisa', org: 'Prins Petfoods', tag: 'Intern Sales Manager', initials: 'LO', note: 'Sales Manager. Primaire contactpersoon voor retailprojecten en veterinaire prioriteiten.' },
  { name: 'Kathy', org: 'Prins Petfoods', tag: 'Intern Buitendienst', initials: 'KA', note: 'Buitendienst. Betrokken bij Avonturia en retailklanten.' },
  { name: 'Anique', org: 'Prins Petfoods', tag: 'Intern', initials: 'AN', note: 'Betrokken bij Gezondheidsplein Accustraat 1.' },
