...
const HARDCODED_SKILLS: SkillCard[] = [
  ...
  { emoji: '🤖', title: 'Artificial Intelligence', description: 'AI-beeldgeneratie (Midjourney, DALL-E, Firefly), vibecoding (tools en apps bouwen via AI) en workflow-automatisering (Make, Power Automate, GPT-integraties)' },
