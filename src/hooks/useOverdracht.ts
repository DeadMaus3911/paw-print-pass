...
const PLACEHOLDER_ITEMS: OverdrachtItem[] = [
  ...
  // Avonturia sub-taken
  {
    ...
    category: 'Avonturia',
    title: 'Servermap referentie',
    description: '📂 Bestanden op de server: 01_Prins / Vormgeving / Winkelconcept corporate / 03_Dierenwinkels / Avonturia',
    done: false,
  },
  {
    id: 'task-avonturia-canvassen',
    category: 'Avonturia',
    title: 'Canvassen 3x',
    description: 'Drie canvassen aanschaffen voor de winkelinrichting.',
    done: false,
  },
  {
    id: 'task-avonturia-pegboards',
    category: 'Avonturia',
    title: 'Pegboards 2x kopen (Bol.com)',
    description: 'Twee pegboard-organizers bestellen via Bol.com.',
    done: false,
  },
  {
    id: 'task-avonturia-wandpanelen',
    category: 'Avonturia',
    title: 'Wandpanelen (lattenwand)',
    description: 'Lattenwand-panelen aanschaffen voor de winkelinrichting.',
    done: false,
  },
  {
    id: 'task-avonturia-forex-pallet',
    category: 'Avonturia',
    title: 'Forex plaat achter pallet',
    description: 'Forex plaat plaatsen achter het pallet.',
    done: false,
  },
  {
    id: 'task-avonturia-forex-vriezer',
    category: 'Avonturia',
    title: 'Forex plaat vriezer',
    description: 'Forex plaat plaatsen bij de vriezer.',
    done: false,
  },
  {
    id: 'task-avonturia-geluidspanelen',
    category: 'Avonturia',
    title: 'Geluidspanelen 4x houtlook',
    description: 'Vier geluidspanelen in houtlook aanschaffen.',
    done: false,
  },
  {
    id: 'task-avonturia-vazen',
    category: 'Avonturia',
    title: 'Vazen en (kunst)planten',
    description: 'Vazen en (kunst)planten toevoegen aan de winkelinrichting.',
    done: false,
  },
  {
    id: 'task-avonturia-signing',
    category: 'Avonturia',
    title: 'Signing aan pilaar',
    description: 'Signing ontwerpen en bevestigen aan de pilaar.',
    done: false,
  },
  {
    id: 'task-avonturia-decoratie',
    category: 'Avonturia',
    title: 'Eventuele decoratie',
    description: 'Aanvullende decoratie-elementen bepalen en aanschaffen.',
    done: false,
  },
  {
    id: 'task-avonturia-montage',
    category: 'Avonturia',
    title: 'Montage',
    description: 'Montage van alle materialen in de winkel.',
    done: false,
  },
  {
    id: 'task-interzoo',
